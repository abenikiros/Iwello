...
export default function Chemist() {
  return (
    <div className="App">
      ...
      <Link to="/Chemist">
        <div className="ChemistButton DoctorButton-M">
      ...
      <p className="pharma-sign-up">Chemist Sign up</p>
      <input className="UserName user-userName" placeholder="Chemist name*" />
      <input className="UserName user-e-mail" placeholder="e-mail*" />
      <input className="Doctor-years" placeholder="  phone no*" />
      <input className="UserName doctor-phone" placeholder="chemist*" />
      <input
        className="UserName user-language"
        placeholder="Do you have a resident chemist?"
      />
      <div className="down">
        <FaCaretDown />
      </div>
